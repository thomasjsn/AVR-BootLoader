...
Config Led_life = Output
Led_life = 0
Config Led_act = Output
Led_act = 0
    ...
    Select Case Bstatus
       ...
       Case 4:                                              ' end of transmission , file is transmitted
            ...
            '  Waitms 100                                   ' OPTIONAL REMARK THIS IF THE DTR SIGNAL ARRIVES TO EARLY
             ...
             Led_life = 0                                   ' simple indication that we are finished and ok
             Led_act = 0
             Waitms 20
...
Writepage:
 ...
 Else                                                       'eeprom
     ...
     Next
 End If
 Toggle Led_act : Waitms 10 : Toggle Led_act                'indication that we write
Return
